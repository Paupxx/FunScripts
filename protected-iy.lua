local Protected = {
    ...
    "rbxassetid://4908465318",
    "rbxassetid://6695644299",
...
local Hooked = {}
local SpoofID = "rbxassetid://10066921516"
local hookn
local checkn = function(f) -- TODO: Make this universal
    if typeof(f) == "function" then
        for i,v in pairs(debug.getconstants(f)) do
            if v=="rbxassetid://1234567890" then
                return true
            else
                return false
            end
...
hookn = hookmetamethod(game,"__namecall",function(self,...) -- TODO: clear cache and improve hook
    if not checkcaller() and typeof(self) == "Instance" then
        if self == ContentProvider then
            args={...}
            tbl,func=args[1],args[2]
            if typeof(tbl) == "table" and typeof(func) == "function" then
                if not Hooked[func] then
                    Hooked[func] = true
